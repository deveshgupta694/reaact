...
function Card({username , btntext="Ladki"}){
    ...
    return(
      ...
      <div className="flex items-center justify-between">
        <button className="px-4 py-2 bg-white hover:bg-gray-200 text-white text-sm rounded-lg transition-colors duration-200">
          {btntext}
        </button>
